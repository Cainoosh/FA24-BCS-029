public class Main {
	public static void main(String[] args) {
		...
		ParkingSystem system = ParkingSystem.getInstance("CUI Lahore", supervisor, 2, 2);
		ParkingSystem secondAttempt = ParkingSystem.getInstance("shouldNotWork", supervisor, 1, 1);
